...
def main():
    ...
    _, camera_params, _ = \
        read_files_replica(folder_path="data/Replica/", data_name="office0_original", num_frames=460, delta=10)
    ...
    plt.savefig("outputs/replica_office0_original.png", format="png", dpi=300)
    plt.show()
